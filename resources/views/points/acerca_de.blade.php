...
@section('contents')
  <div class="row">
    ...
    <p> "SensorClima" fue creada con el propósito de mapear la temperatura y humedad en diferentes lugares y registrar estos datos 
      en una base de datos para su posterior análisis. Este tipo de sistema es comúnmente utilizado en aplicaciones de monitoreo 
      ambiental, gestión de climatización, o cualquier entorno donde sea crucial controlar y analizar las condiciones climáticas.</p>
  </div>
